...
public class TemplateBuilder {
    ...
    public static TemplateDto buildTemplateDto() {
    ...
    public static TemplateDto buildRect() {
        TemplateDto template = new TemplateDto();
        template.setName("invoiceExample");
        PageFormatDto pageFormat  = new PageFormatDto(PageFormat.A4, 0);
        template.setPageFormat(pageFormat);
        template.setDefaultRect(StyleBuilder.build(3));
        template.getBlocks().add(new BlockDto());
        template.getBlocks().get(0).getElements().add(ElementBuilder.buildRectElement(50, 50, 50, 50, true));
        return template;
    }
